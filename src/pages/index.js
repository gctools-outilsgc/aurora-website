              ...
              <Container>
                ...
                <div>
                  ...
                  <div className="mb-3 mt-2">
                    <a className="ext-link-text mr-3 mt-2" href="https://github.com/gctools-outilsgc/aurora-design-system"><FontAwesomeIcon className="mr-2" style={{"fontSize":"1.5em", "color":"black"}} icon={faGithub} />{t("GithubLink")}</a>
