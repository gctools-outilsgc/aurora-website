              ...
              <div className="navbar-collapse nav-holder">
                ...
                <Nav className="ml-auto" navbar>
                  <NavItem className="d-none d-md-block">
                    <NavLink style={{"color":"black", "width": "48px", "height": "44px"}} target="_blank"  href="https://github.com/gctools-outilsgc/aurora-design-system"><FontAwesomeIcon style={{"fontSize":"1.5em"}} icon={faGithub} /><span className="sr-only">GitHub</span></NavLink>
                  </NavItem>
                  <NavItem className="d-none d-md-block">
                    <Link style={{"color":"black", "width": "48px", "height": "44px"}} to="/overview/download" className="nav-link"><FontAwesomeIcon style={{"fontSize":"1.5em"}} icon={faDownload} /><span className="sr-only">{t("DownloadLink")}</span></Link>
                  </NavItem>
                </Nav>
            </Navbar>
          </div>
