...
class MarkdownRenderer extends React.Component {
  render() {
    const renderAst = new rehypeReact({
      ...
      components: {
        htmlalertexample1: HtmlExamples.AlertExample1, htmlalertexample2: HtmlExamples.AlertExample2, htmlalertexample3: HtmlExamples.AlertExample3,
        reactalertexample1: ReactExamples.AlertExample1, reactalertexample2: ReactExamples.AlertExample2, reactalertexample3: ReactExamples.AlertExample3, 
