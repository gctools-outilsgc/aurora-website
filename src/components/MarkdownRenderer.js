  ...
  render() {
    const renderAst = new rehypeReact({
      ...
      components: {
        ...
        reactalert1: ReactExamples.AlertExample1, reactalert2: ReactExamples.AlertExample2, reactalert3: ReactExamples.AlertExample3, reactfade1: OmarExamples.FadeExample1,
