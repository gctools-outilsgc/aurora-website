...
class MarkdownRenderer extends React.Component {
  render() {
    const renderAst = new rehypeReact({
      ...
      components: {
        reactdropdown3: ReactExamples1.Dropdown3, htmldropdown3: HtmlExamples1.Dropdown3, reactdropdown2: ReactExamples1.Dropdown2, htmldropdown2: HtmlExamples1.Dropdown2, reactdropdown1: ReactExamples1.Dropdown1, htmldropdown1: HtmlExamples1.Dropdown1, htmlalert1: HtmlExamples.AlertExample1, htmlalert2: HtmlExamples.AlertExample2, htmlalert3: HtmlExamples.AlertExample3, htmlbadge1: HtmlExamples.BadgeExample1, htmlbadge2: HtmlExamples.BadgeExample2, htmlbadge3: HtmlExamples.BadgeExample3,
